...
public class StarcatcherCompat {
    ...
    public static void completeCatch(ServerPlayer player, TideFishingHook hook, boolean perfectCatch) {
        ...
        if (optional.isEmpty()) {
            ...
            if (WARNED_MISSING_FISH.add(unknownFish)) Tide.LOG.warn("No starcatcher fish properties found for {}", unknownFish);
            return;
        }
        FishProperties properties = optional.get();
        ...
        if (Tide.SERVER_CONFIG.minigame.useThirdPartyFishData) {
